...
Read [dataset and architecture research](docs/research.md) before interpreting
model coverage. This is a research baseline; a trained checkpoint is not by
itself evidence of reliable production MD.

The [expanded AIMD inventory and suitability audit](docs/aimd_expansion.md)
...
accuracy benchmark. See [simulation protocol](docs/simulation_validation.md).
